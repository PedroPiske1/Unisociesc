...
public class operacoes {
	...
	/*
	 * Em uma subtração nroMinuendo - nroSubtraendo = nroDiferenca,
	 * nroMinuendo é chamado minuendo, nroSubtraendo é chamado subtraendo
	 * e nroDiferenca é chamado resto ou diferença
	 */
	...
	public int exponenciacao() {
		int resultado =1;
		for (int index = 1; index <= this.nroGenerico2; index++) {
			resultado *= this.nroGenerico1;
		}
